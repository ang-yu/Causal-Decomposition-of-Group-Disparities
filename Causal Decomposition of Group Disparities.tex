...
Baseline           & $0.241^{***}$ & $0.250^{***}$ & $0.246^{***}$ & $0.245^{***}$ \\
Prevalence         & $0.054^{*}$   & $0.098^{**}$  & $0.065^{***}$ & $0.069^{**}$  \\
Effect             & $-0.014$      & $-0.058$      & $-0.022$      & $-0.030$      \\
Selection          & $0.004$       & $-0.005$      & $-0.003$      & $0.001$       \\
Jackson reduction  & $0.060^{*}$   & $0.096^{**}$  & $0.065^{***}$ & $0.069^{**}$  \\
   \hline
...
\begin{tabular}{lccc}
  ...
  Baseline outcome & $0.627^{***}$ & $0.386^{***}$ & $0.241^{***}$ \\ 
  ATE & $0.111^{***}$ & $0.144^{*}$ & $-0.033$ \\ 
  $\Cov(D, \tau)$ & $-0.002$ & $-0.005$ & $0.004$ \\ 
  & \multicolumn{3}{c}{Neural Networks}  \\
  Baseline outcome & $0.624^{***}$ & $0.374^{***}$ & $0.250^{***}$ \\ 
  ATE & $0.122^{*}$ & $0.260^{**}$ & $-0.138$ \\ 
  $\Cov(D, \tau)$ & $-0.003$ & $0.002$ & $-0.005$ \\ 
  & \multicolumn{3}{c}{Random Forests}  \\
  Baseline outcome & $0.626^{***}$ & $0.379^{***}$ & $0.246^{***}$ \\ 
  ATE & $0.119^{***}$ & $0.172^{***}$ & $-0.053$ \\ 
  $\Cov(D, \tau)$ & $-0.003$ & $0.000$ & $-0.003$ \\ 
  & \multicolumn{3}{c}{Parametric Regressions}  \\
  Baseline outcome & $0.624^{***}$ & $0.379^{***}$ & $0.245^{***}$ \\ 
  ATE & $0.113^{***}$ & $0.184^{**}$ & $-0.071$ \\ 
...
Total                       & $0.286^{***}$ & $0.286^{***}$ & $0.286^{***}$ & $0.286^{***}$ \\
Baseline                    & $0.241^{***}$ & $0.250^{***}$ & $0.246^{***}$ & $0.245^{***}$ \\
Conditional prevalence      & $0.016^{*}$   & $0.026^{**}$  & $0.031^{***}$ & $0.016^{**}$  \\
Conditional effect          & $0.012$       & $-0.038$      & $-0.019$      & $-0.018$      \\
Conditional selection       & $-0.001$      & $-0.006$      & $-0.011^{*}$  & $-0.001$      \\
$\Q$ distribution              & $0.017$       & $0.053^{*}$   & $0.038$       & $0.044$       \\
Conditional Jackson reduction & $0.019^{**}$  & $0.027^{**}$  & $0.031^{***}$ & $0.015^{**}$  \\ \hline
  \multicolumn{5}{l} {\makecell{Note: P value $<$ 0.05: *, $<$ 0.01: **, $<$ 0.001: ***. Weight stabilization is used. \\ For ML-based estimators, cross-fitting is used.}}
\end{tabular}
\end{table}
