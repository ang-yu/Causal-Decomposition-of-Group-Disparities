...
\begin{tikzpicture}[scale = 1] 
    ...
    \node[anchor=center, align=center, inner sep=0pt] at (0,0) {\includegraphics[width=.48\textwidth]{unconditional_2023-06-04.jpg}};
\end{tikzpicture}
}
...
\begin{tikzpicture}[scale = 1]  
    ...
    \node[anchor=center, align=center, inner sep=0pt] at (0,0) {\includegraphics[width=.48\textwidth]{conditional_2023-06-04.jpg}}; 
\end{tikzpicture}
}
